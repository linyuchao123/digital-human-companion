...
卡片分开显示采集质量和近期稳定观察。摘要由后端当前连接的短时窗口生成，
如“嘴角持续上扬，可能在微笑”或“没有明显持续表情变化”；不显示心理诊断或虚假置信度。
单次眨眼不会被摘要当成持续闭眼。质量下降、无人或多人入镜立即停止使用旧观察。
质量提示按面部区域亮度、人脸大小和边界容忍判断，区分偏暗、强光、距离和不完整入镜。
这些仍是启发式提示，不是专业图像清晰度指标，需要实际摄像头验证。
