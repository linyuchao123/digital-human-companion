...
class VoiceFrontendTests(unittest.TestCase):
    ...
    def test_guest_experience_entry_is_removed(self):
        self.assertNotIn('id="auth-guest"', self.html)
        self.assertNotIn('continueAsGuest()', self.html)
        self.assertNotIn('游客模式 · 浏览器本地音色', self.html)
