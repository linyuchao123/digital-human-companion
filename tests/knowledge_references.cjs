...
assert(html.includes('queueReplySpeech(msg.text,false)')&&html.includes("replace(/\\[\\d{1,3}\\]/g,''"),'TTS uses streamed reply text with reference numbers removed, not reference DOM');
